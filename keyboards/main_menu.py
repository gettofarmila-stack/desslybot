...
def main_menu_builder():
    ...
    builder.row(types.InlineKeyboardButton(text='Мобильные игры', callback_data='mobile_refill', style='primary'), types.InlineKeyboardButton(text='Ваучеры', callback_data='vouchers', style='primary'))
